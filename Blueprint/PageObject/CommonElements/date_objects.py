...
class DateObjects(BasePage):
    ...
    def get_next_month_button(self) -> WebElement:
        ...
        element = self.find_element.by_xpath(locators.NEXT_MONTH_BUTTON_LOCATOR)
        return element
        
    def get_date_default_year_select(self) -> WebElement:
        """Finds and returns date default value year select."""
        element = self.find_element.by_xpath(locators.DEFAULT_DATE_YEAR_SELECT_LOCATOR)
        return element
    ...
    def get_date_default_year_value(self, year: str) -> WebElement:
        ...
        new_xpath = locators.DATE_DEFAULT_YEAR_OPTION_LOCATOR.replace("<<value>>", year)
        try:
    ...
    def get_date_default_month_select(self) -> WebElement:
        ...
        element = self.find_element.by_xpath(locators.DEFAULT_DATE_MONTH_SELECT_LOCATOR)
        return element
    ...
    def get_date_default_month_value(self, month: str) -> WebElement:
        ...
        new_xpath = locators.DATE_DEFAULT_MONTH_OPTION_LOCATOR.replace("<<value>>", month)
        try:
            element = self.find_element.by_xpath(new_xpath)
            return element
        except Exception:
    ...
    def get_date_default_day_value(self, day: str) -> WebElement:
        ...
        new_xpath = locators.DATE_DEFAULT_DAY_OPTION_LOCATOR.replace("<<value>>", day)
        try:
            element = self.find_element.by_xpath(new_xpath)
            return element
        except Exception:
