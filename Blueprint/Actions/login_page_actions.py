...
class LoginPage(BasePage):
    ...
    def insert_user(self):
        ...
        self.find_element.by_id(locators.INPUT_LOCATOR).send_keys(os.environ.get("USER"))

    def insert_password(self):
        """Inserts the value of the 'PASSWORD' environment variable into the password input field."""
        self.find_element.by_id(locators.PASSWORD_LOCATOR).send_keys(os.environ.get("PASSWORD"))

    def click_in_sign_button(self):
        """Clicks the sign-in button element"""
        self.find_element.by_id(locators.SIGN_IN_BUTTON_LOCATOR).click()
