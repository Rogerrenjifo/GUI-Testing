...
class FormsActions(FormObjects):
    ...
    def select_field_to_edit_in_forms(self, field_title: str):
    ...
    def set_text_input_in_forms(self, field_title: str, input_text: str):
        """Edits text field into given value."""
        self.select_field_to_edit_in_forms(field_title)
        self.get_editable_text_input().clear()
        self.get_editable_text_input().send_keys(input_text)

    def click_save_changes_in_forms(self):
        """Saves changes made on the editing field."""
        self.get_save_button().click()

    def click_cancel_changes_in_forms(self):
        """Cancels changes made on the editing field."""
        self.get_cancel_button().click()

    def set_dropdown_value_in_forms(self, field_title: str, value: str):
    ...
    def set_numeric_input_in_forms(self, field_title: str, value: str):
    ...
    def click_checkbox_label_in_forms(self, field_title: str):
        """Selects or des-selects a checkbox with field title given."""
        self.select_field_to_edit_in_forms(field_title)
        self.get_checkbox_label(field_title).click()

    def edit_date_in_forms(self, field_title: str, year: str, month: str, day: str):
        """Selects a date on the field with the title given."""
        self.select_field_to_edit_in_forms(field_title)
        self.get_editable_text_input().click()
        DateActions().set_date(year, month, day)

    def set_multiline_text_input_in_forms(self, field_title: str, input_text: str):
    ...
    def select_user_from_userlist_in_forms(self, field_title: str, user_name: str):
