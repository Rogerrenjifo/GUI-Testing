...
class HeaderActions(Header):
    ...
    def click_delete_button_in_header(self):
    ...
    def click_close_button_in_header(self):
    ...
    def deploy_select_version_in_header(self):
    ...
    def click_version_in_header(self, version: str):
