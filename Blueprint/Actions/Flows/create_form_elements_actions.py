...
class CreateFormElementsActions(CreateFormElementsObjects):
    ...
    def add_element_to_column_section(self, element_type: str, section_column_id: str):
        ...
        element = self.select_element_type(element_type)
        self.action_chains.custom_drag_and_drop(element, section)

    def add_element_down_existent_element(self, element_type: str, existent_element_title: str):
        ...
        source = self.select_element_type(element_type)
        self.action_chains.drag_and_drop_element(source, target)

    def add_element_up_to_existent_element(self, element_type: str, existent_element_id: str):
    ...
    def add_section_up_other(self, existing_section_title: str):
        """Adds a new section on top of an existing one"""
        source = self.get_section_element()
        target = self.main_panel.get_section_title(existing_section_title)
        self.action_chains.custom_drag_and_drop(source, target, direction="up")

    def add_section_down_other(self, existing_section_title: str):
