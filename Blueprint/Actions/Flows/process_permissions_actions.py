...
class ProcessPermissionsActions(ProcessPermissions):
    ...
    def get_section_visibility_title_in_process_permission(self) -> str:
    ...
    def get_initiate_process_title_in_process_permission(self) -> str:
    ...
    def select_user_in_dropdown_in_process_permission(self, user:str):
    ...
    def delete_selected_users_in_dropdown_in_process_permission(self, names: list):
