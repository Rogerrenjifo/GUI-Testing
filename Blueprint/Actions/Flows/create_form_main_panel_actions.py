...
class FormMainPanelActions(FormMainPanelPage):
    ...
    def select_section(self, section_title: str):
        """Clicks a section from main panel for display its properties"""
        self.get_section(section_title).click()

    def move_component_between_sections(self, component_id: str, column_id: str):
    ...
    def move_section_up_other(self, source_section_title: str, target_section_title: str,
    ...
    def move_section_down_other(self, source_section_title: str, target_section_title: str,
                                source_index=None, target_index=None):
    ...
    def move_component_up_other(self, source_component_id: str, target_component_id: str):
    ...
    def move_component_down_other(self, source_component_id: str, target_component_id: str):
        """Moves a component below another component"""
        source = self.get_component(source_component_id)
        target = self.get_component(target_component_id)
        self.action_chains.custom_drag_and_drop(source, target)

    def delete_section(self, section_title: str, index=None):
        """Deletes a section from its drop-down menu"""
        self.display_section_delete_menu(section_title, index)
        self.select_section_delete_button()

    def delete_component(self, component_id):
        """Deletes a component from its drop-down menu"""
        self.display_component_delete_menu(component_id)
        self.select_component_delete_button(component_id)

    def display_section_delete_menu(self, section_title: str, index=None):
    ...
    def display_component_delete_menu(self, component_id: str):
    ...
    def select_component_delete_button(self, component_id: str):
