...
class FlowAdminPermissionsVerifications:
    """This class represents the verifications of the Flow Admin Permissions section"""
    def __init__(self):        
        self.actions = FlowPermissionsActions()
        self.verification = Verification()

    def rgb_color_of_label_should_be_as_expected(self, expected_color: str):
        """Verifies that the rgb color of label is displayed in the expected color"""
        actual_color = self.actions.obtain_rgb_color_of_label_in_flow_permissions()
        self.verification.verify_equal_ignore(actual_color, expected_color)

    def rgb_color_of_text_box_should_be_as_expected(self, expected_color: str):
        """Verifies that the rgb color of text box is displayed in the expected color"""
        actual_color = self.actions.obtain_rgb_color_of_text_box_in_flow_permissions()
        self.verification.verify_equal_ignore(actual_color, expected_color)

    def rgb_color_of_delete_button_should_as_expected(self, name: str, expected_color: str):
        """Verifies that the rgb color of delete button is displayed in the expected color"""
        actual_color = self.actions.obtain_rgb_color_of_delete_button_in_flow_permissions(name)
        self.verification.verify_equal_ignore(actual_color, expected_color)
    ...
    def users_selected_list_should_not_contain(self, name: str):
    ...
    def message_in_empty_text_box_should_be_as_expected(self, expected_message: str):
        """Verifies that the message in the empty text box is displayed as expected"""
        actual_message = self.actions.obtain_message_in_empty_text_box_in_flow_permissions()
        self.verification.verify_equal_ignore(actual_message, expected_message)

    def message_empty_dropdow_should_be_as_expected(self, expected_message: str):
        """Verifies that the message is displayed as expected when the text box is empty"""
        actual_message = self.actions.obtain_message_empty_dropdown_in_flow_permissions()
        self.verification.verify_equal_ignore(actual_message, expected_message)

    def dropdown_should_be_visible(self):
        """Verifies that the dropdown is visible"""
        dropdown = self.actions.obtain_visible_element_in_flow_permissions()
        self.verification.verify_is_not_equal(dropdown, False)

    def dropdown_should_not_be_visible(self):
        """Verifies that the dropdown is not visible"""
        dropdown = self.actions.obtain_visible_element_in_flow_permissions()
        self.verification.verify_equal_ignore(dropdown, False)

    def text_box_should_not_be_empty(self):
        """Verifies that the text box is not empty"""
        result = self.actions.obtain_typed_characters_in_dropdown_in_flow_permissions()
